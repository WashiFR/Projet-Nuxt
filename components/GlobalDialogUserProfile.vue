...
<template>
    <Dialog :visible="dialog.dialogVisible.value" modal :style="{ width: '25rem', padding: '2rem' }">
        <template #container>
            <div class="absolute right-0 top-0 p-2 test">
                <Button icon="pi pi-times" severity="secondary" variant="text" rounded @click="dialog.closeDialog()" />
            </div>
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex flex-col gap-2">
                                ...
                                <IconField>
                                    ...
                                    <InputText placeholder="Jhon Doe" default-value="Jhon Doe" fluid autofocus />
                                </IconField>
                            </div>
                            <div class="flex flex-col gap-2">
                                <label>Email</label>
                                <IconField>
                                    ...
                                    <InputText placeholder="jhon.doe@gmail.com" default-value="jhon.doe@gmail.com" fluid />
                                </IconField>
                            </div>
